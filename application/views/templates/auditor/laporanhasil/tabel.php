                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('auditor/laporanakhir/') . $value->id_hasilaudit ?> "><button class="sbtn btn" style="background-color: #DCDCDC;"><i class="fa fa-eye" style="color: #696969;"></i></button></a>
                                <a href="<?= base_url('auditor/edit_data/') . $value->id_hasilaudit ?>"><button class="sbtn btn" style="background-color: #DCDCDC;"><i class="fa fa-edit" style="color: #4169E1;"></i></button></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
