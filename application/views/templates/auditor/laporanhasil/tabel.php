                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('prodi/edit_data/') . $value->id_hasilaudit;?>"><button type="edit" class="sbtn btn" style="background-color: #DCDCDC;"><i class="fa fa-edit" style="color: 	#4169E1;"></i></button></a>
     </div>
        </td>
        </tr>
    <?php endforeach; ?>
