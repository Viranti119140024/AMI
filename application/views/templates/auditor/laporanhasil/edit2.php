<div class="container">
    ...
    <div class="card">
        <div class="card-body">
        <form enctype="multipart/form-data" method="post" class="form-horizontal form-label-left" novalidate action="<?= base_url('auditor/edit_data2_post/') . $bab2_hasil_audit[0]->id_bab2 ?>">
