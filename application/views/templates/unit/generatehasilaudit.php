    ...
    <div class="card mt-2">
        <div class="card-body">
            <center class="text-dark mt-8">
                <h5><b>LAPORAN AUDIT MUTU INTERNAL <?= $hasilaudit->tahun ?> <br>Unit<?= $hasilaudit->lembaga ?> <br></b></h5>
            </center>
...
<div class="container-fluid">
    <div class="row-lg-12">
        <div class="card mt-2">
            <div class="card-body">
                <h4 class="d-flex justify-content-center align-items-center mt-3 font-weight-bold text-dark">Hasil Desk Evaluation</h4>
    ...
    <div class="row-lg-12 mt-2">
        <div class="card mt-2">
            <div class="card-body">
                <h4 class="d-flex justify-content-center align-items-center mt-3 font-weight-bold text-dark">Daftar Tilik (Checklist)</h4>
