<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form enctype="multipart/form-data" method="post" class="form-horizontal form-label-left" novalidate action="<?= base_url('unit/isidata/') ?>">
                ...
                <div class="form-group">
                    <label for="exampleFormControlInput1" style="color: black;">Unit</label>
                    <input type="text" class="form-control" id="prodi" name="prodi" placeholder="Masukkan Unit">
                </div>
