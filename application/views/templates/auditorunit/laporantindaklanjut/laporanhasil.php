<div class="container">
    ...
    <div class="card mt-2">
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-body" style="font-family:Arial, Helvetica, sans-serif; color:black; font-size:large;">
                    <a class="btn btn-success" type="button" href="<?= base_url('auditorunit/isidata2/') . $hasilaudit[0]->id_hasilaudit ?>" class="text-white" href="#">+ Tambah</a>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td scope style="color: black;"="row"><?= $value->permintaan_tindakan; ?></td>
                                              <th> <a href="<?= base_url('auditorunit/edit_data2/') . $value->id_bab2; ?>"><button type="edit" class="sbtn btn" style="background-color: #DCDCDC;"><i class="fa fa-edit" style="color: #4169E1;"></i></button></a></th>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tbody>
