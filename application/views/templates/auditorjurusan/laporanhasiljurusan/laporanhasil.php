<div class="container">
    ...
    <div class="card mt-2">
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-body" style="font-family:Arial, Helvetica, sans-serif; color:black; font-size:large;">
                    <a class="btn btn-success" type="button" href="<?= base_url('auditorjurusan/isidata2/') . $hasilaudit[0]->id_hasilaudit ?>" class="text-white" href="#">+ Tambah</a>
                            ...
                            <tbody style="background-color: white; color:black;">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!-- <th> <a href="<?= base_url('auditorjurusan/edit_data2/') . $value->id_hasilaudit; ?>"><button type="edit" class="sbtn btn" style="background-color: #DCDCDC;"><i class="fa fa-edit" style="color: #4169E1;"></i></button></a></th> -->
                ...
                <form method="post" class="form-horizontal form-label-left" novalidate action="<?= base_url('auditorjurusan/generate_pdf_hasil_audit/' . $params) ?>">
