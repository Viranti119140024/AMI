        ...
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-body" style="font-family:Arial, Helvetica, sans-serif; color:black; font-size:large;">
                    ...
                    <br> <br> <b> 1.3 Waktu dan Pelaksanaan Audit</b><br></p>
                            ...
                            <tbody style="background-color: white; color:black;">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!-- <th> <a href="<?= base_url('auditorjurusan/edit_data2/') . $value->id_bab2; ?>"><button type="edit" class="sbtn btn" style="background-color: #DCDCDC;"><i class="fa fa-edit" style="color: #4169E1;"></i></button></a></th> -->
