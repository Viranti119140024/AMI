        ...
        <div class="card-body">
            <table id="myTable" class="table" style="color: black;">
                ...
                <tbody>
                    ...
                    <?php
                    foreach ($admin_hasil_desk_jurusan as $key => $value) :
                        $number = $key + 1;
                    ?>
                        <tr>
    ...
    <div class="card mt-2">
        ...
        <div class="card-body">
            <table id="myTable" class="table" style="color: black;">
                ...
                <?php
                foreach ($admin_daftar_tilik_jurusan as $key => $value) :
                    $number = $key + 1;
                ?>
                    <tr>
                        <th scope style="color: black;"="row"><?= $number; ?></th>
...
<div class="modal fade" id="hasilDeskeModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url("User/tambah_hasil_desk_jurusan") ?>" method="post">
...
<div class="modal fade" id="daftarTilik" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url("User/tambah_daftar_tilik_jurusan") ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
