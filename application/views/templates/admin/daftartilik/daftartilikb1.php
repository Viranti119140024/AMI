    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
             ...
             <tr>
                 <td>2</td>
                 <td>Materi Bahan Perkuliahan materi (14 pertemuan)</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
             ...
             <tr>
                 <td>3.</td>
                 <td>Berita Acara Perkuliahan</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
             ...
             <tr>
                 <td>4.</td>
                 <td>Pedoman Akademik Program Studi</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
             ...
             <tr>
                 <td>5.</td>
                 <td>Dokumen Kode ETik Mahasiswa, Dosen, Tendik (ITERA)</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
     ...
     <p style="color:black;"> * M= Memenuhi, MP= Melampaui, MB= Belum Memenuhi, MY= Menyimpang <br> <br>* OB= Observasi, KTS= Ketidaksesuaian</br></br></p>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-end mt-2">
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('user/daftartilik1') ?>">Previous</a>
                </li>
                <li class="page-item"><a class="page-link" href="#">1</a></li>
                <li class="page-item"><a class="page-link" href="#">2</a></li>
                <li class="page-item"><a class="page-link" href="#">3</a></li>
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('user/daftartilik3') ?>">Next</a>
                </li>
            </ul>
        </nav>
    </div>
