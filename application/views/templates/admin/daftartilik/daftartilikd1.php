    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                 <td>1</td>
                 <td>Dokumen Arsip Nilai Mahasiswa/DNA</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
             ...
             <tr>
                 <td>2</td>
                 <td>Dokumen Portfolio Mata Kuliah</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
             ...
             <tr>
                 <td>3.</td>
                 <td>Dokumen rekap IPK mahasiswa setiap angkatan </td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
             ...
             <tr>
                 <td>4.</td>
                 <td>Rekap Presensi Perkuliahan setiap mata kuliah</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
     ...
     <p style="color:black;"> * M= Memenuhi, MP= Melampaui, MB= Belum Memenuhi, MY= Menyimpang <br> <br>* OB= Observasi, KTS= Ketidaksesuaian</br></br></p>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-end mt-2">
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('user/daftartilik5') ?>">Previous</a>
                </li>
                <li class="page-item"><a class="page-link" href="#">1</a></li>
                <li class="page-item"><a class="page-link" href="#">2</a></li>
                <li class="page-item"><a class="page-link" href="#">3</a></li>
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('user/daftartilik7') ?>">Next</a>
                </li>
            </ul>
        </nav>
    </div>
