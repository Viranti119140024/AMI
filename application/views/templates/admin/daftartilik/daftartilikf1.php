    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                 <td>1</td>
                 <td>Dokumen Roadmap Penelitian Program studi sesuai KK masing masing</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
             ...
             <tr>
                 <td>2</td>
                 <td>Dokumen monitoring Penelitian sesuai roadmap dan visi misi PS oleh ketua KK</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
             ...
             <tr>
                 <td>3.</td>
                 <td>Dokumen data hasil penelitian mecakup 
             ...
             <tr>
                 <td>4.</td>
                 <td>Dokumen penelitian yang diintegrasikan dengan bahan ajar Mata Kuliah</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
             ...
             <tr>
                 <td>5.</td>
                 <td>Dokumen evaluasi kesesuaian peneltian dosen sesuai radmaps 
                    Penelitian Program studi sesuai KK masing masing</td>
                 <td></td>
                 <td></td>
                 <td></td>
                 <td></td>
     ...
     <p style="color:black;"> * M= Memenuhi, MP= Melampaui, MB= Belum Memenuhi, MY= Menyimpang <br> <br>* OB= Observasi, KTS= Ketidaksesuaian</br></br></p>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-end mt-2">
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('user/daftartilik9') ?>">Previous</a>
                </li>
                <li class="page-item"><a class="page-link" href="#">1</a></li>
                <li class="page-item"><a class="page-link" href="#">2</a></li>
                <li class="page-item"><a class="page-link" href="#">3</a></li>
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('user/daftartilik11') ?>">Next</a>
                </li>
            </ul>
        </nav>
    </div>
