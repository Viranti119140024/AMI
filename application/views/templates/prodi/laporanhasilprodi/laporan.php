            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody style="background-color: white; color:black;">
                        <tr>
                            <td>Penyusunan</td>
                            <td><?= $tindaklanjut[0]->nama_penyusunan ?></td>
                            <td>Auditee</td>
                            <!-- <td></td> -->
                        </tr>
                        ...
                        <tr>
                            <td>Pemeriksaan 1</td>
                            <td><?= $tindaklanjut[0]->pemeriksa1 ?></td>
                            <td>Auditor</td>
                            <!-- <td></td> -->
                            <!-- <td></td> -->
                        </tr>
                        ...
                        <tr>
                            <td>Pemeriksaan 2</td>
                            <td><?= $tindaklanjut[0]->pemeriksa2 ?></td>
                            <td>Auditor</td>
                            <!-- <td></td> -->
                            <!-- <td></td> -->
                        </tr>
                        ...
                        <tr>
                            <td>Penetapan 1</td>
                            <td><?= $tindaklanjut[0]->penetapan1 ?></td>
                            <td>Kepala SPM</td>
                            <!-- <td></td> -->
                            <!-- <td></td> -->
                        </tr>
                        ...
                        <tr>
                            <td>Penetapan 2</td>
                            <td><?= $tindaklanjut[0]->penetapan2 ?></td>
                            <td>Ketua AMI</td>
                            <!-- <td></td> -->
                            <!-- <td></td> -->
                        </tr>
                ...
                <div class="card">
                    ...
                    <div class="text-right" style="font-family:Arial, Helvetica, sans-serif; color:black; font-size:large;">
                        ...
                        <p>Auditee <?= $tindaklanjut[0]->nama_penyusunan ?></p>
                ...
                <div class="card">
                    <div class="card-body" style="font-family:Arial, Helvetica, sans-serif; color:black; font-size:large;">
                        ...
                        2.Waktu Pelaksanaan : <?= $tindaklanjut[0]->waktu ?> <br>3.Tempat Kegiatan : <?= $tindaklanjut[0]->tempat ?> <br>4.Auditor : <?= $tindaklanjut[0]->auditor ?> <br>5.Auditee : <?= $tindaklanjut[0]->auditee ?>
