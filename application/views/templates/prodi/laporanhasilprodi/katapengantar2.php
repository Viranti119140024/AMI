...
<div class="card">
  ...
  <center class="text-dark mt-8" style="color:black;"> <h4>KATA PENGANTAR</h4> </center> 
  Segala puji bagi Allah Subhanahu wa Ta’ala karena hanya dengan limpahan rahmat dan bimbinganNya laporan tindak lanjut temuan Audit Mutu Internal siklus periode xx tahun 
  2023 Program Studi/Jurusan/Unit Kerja berhasil diselesaikan. Laporan ini merupakan salah satu bentuk komitmen Studi/Jurusan/Unit Kerja untuk meningkatkan mutu penyelenggaraan
...
sehingga kegiatan audit dapat terlaksana dengan baik dan lancar.</br>
  ...
  <div class="text-right" style="font-family:Arial, Helvetica, sans-serif; color:black; font-size:large;">
	<p>Lampung Selatan, 18 Juni 2023 </p> <p>Auditee</p>
  ...
  <button class="btn btn-success" type="submit">Edit</button>
       ...
       <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-end mt-2">
            <li class="page-item">
              <a class="page-link" href="<?= base_url('prodi/laporanhasilprodi') ?>">Previous</a>
            </li>
              <li class="page-item"><a class="page-link" href="#">1</a></li>
              <li class="page-item"><a class="page-link" href="#">2</a></li>
              <li class="page-item"><a class="page-link" href="#">3</a></li>
              <li class="page-item">
              <a class="page-link" href="<?= base_url('prodi/BabSatu') ?>">Next</a>
            </li>
          </ul>
        </nav>
     </div>
