...
<div class="card">
  ...
  <center class="text-dark mt-8" style="color:black;"> <h4><b>BAB I <br> PENDAHULUAN </br></b></h4> </center> 
...
<br> <br> SPMI yang dilaksanakan ITERA bertujuan untuk menjamin pemenuhan Standar
...
Pelaksanaan, Evaluasi, Pengendalian dan Pengembangan standar yang telah ditetapkan. Pada tahapan Evaluasi dapt dilakukan melalui Audit Mutu Intenal.
</br> <br> Audit Mutu Internal (AMI) merupakan suatu pemeriksaan yang sistematis dan
...
<br><br> Proses audit dilaksanakan dalam 2 tahap, yaitu desk evaluation dan audit lapangan. Aspek yang dievaluasi untuk kinerja unit adalah proses atau kegiatan yang berdasarkan
kesesuaian (1) Pengelolaan pembelajaran, (2) Suasana Akademik (3) Sumber daya manusia, (4) Layanan Semester Pendek, (5) Layanan pembinaan softskill (6)
Standar waktu kerja dosen dan tendik, (7) Standar pengembangan karir dosen dan tendik, (8) Standar perjalanan dinas dosen dan tendik.
...
<br> Kegiatan Audit Mutu Internal periode pertama tahun 20xx oleh tim Auditor LP3M ITERA dilakukan pada: <br> 1.Hari / Tanggal : <br>
2.Waktu Pelaksanaan : <br>3.Tempat Kegiatan : <br>4.Auditor : <br>5.Auditee : <br>6.Dokumentasi :
<form>
...
<br>- Surat Keputusan Rektor Institut Teknologi Sumatera Nomor 226/IT9.A/SK/PJ/2017 tentang Sistem Penjaminan Mutu Internal Institut Teknologi Sumatera</br>
       ...
       <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-end mt-2">
            <li class="page-item">
              <a class="page-link" href="<?= base_url('jurusan_controller/kp1') ?>">Previous</a>
            </li>
              <li class="page-item"><a class="page-link" href="#">1</a></li>
              <li class="page-item"><a class="page-link" href="#">2</a></li>
              <li class="page-item"><a class="page-link" href="#">3</a></li>
              <li class="page-item">
              <a class="page-link" href="<?= base_url('jurusan_controller/daftartemuan') ?>">Next</a>
            </li>
          </ul>
        </nav>
