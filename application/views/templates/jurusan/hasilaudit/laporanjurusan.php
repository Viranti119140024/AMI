...
<div class="card mt-2">
  <div class="card-body">
  <center class="text-dark mt-8"> <h5>LAPORAN AUDIT MUTU INTERNAL 2023/2024 <br>JURUSAN .....<br></h5> </center> 
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-end mt-2">
                <li class="page-item disabled">
                    ...
                    <li class="page-item">
                    <a class="page-link" href="<?= base_url('jurusan_controller/kp1') ?>">Next</a>
                </li>
            </ul>
        </nav>
     </div>
