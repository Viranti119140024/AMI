    ...
    <div class="card">
        <div class="card-body">
            <div class="text-dark mt-8">
                <h5 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color:black;"><b>Upload Link Drive Dokumen Kebutuhan Audit Jurusan</b></h5>
            </div>
            <b>
                <hr color="red" />
                ...
                <form method="POST" action="<?php echo base_url('jurusan_controller/terima_link_drive') ?>">
