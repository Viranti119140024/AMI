    ...
    <div class="card">
        <div class="card-body">
            <div class="text-dark mt-8">
                <h5 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color:black;"><b>Upload Dokumen Kebutuhan Audit Jurusan</b></h5>
            </div>
            <b>
                <hr color="red" />
            </b>
            <form enctype="multipart/form-data" method="post" class="form-horizontal form-label-left" novalidate action="<?= base_url('jurusan_controller/upload_dokumen/') . $id ?>">
