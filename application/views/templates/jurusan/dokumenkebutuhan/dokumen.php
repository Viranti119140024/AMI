  ...
  <div class="card">
    <div class="card-body">
      <center class="text-dark mt-8" style="color:black;">
        <h5><b>DOKUMEN KEBUTUHAN AUDIT JURUSAN</br></b></h5>
      </center>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="<?= base_url('jurusan_controller/upload_dokumen/') . $value->id_dokumen ?> "><button type="upload" class="sbtn btn" style="background-color: #DCDCDC;"><i class="fa fa-upload" style="color:#696969;"></i></button></a>
