<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar font-weight shadow mx-4 p-2" style="background: #fff;">
        ...
        <li class="list-group">
            <a class="list-group-item" href="<?= base_url('unit/berandaunit') ?>">
                <i class="fas fa-fw fa-home itemcolor"></i>
                <span class="itemcolor">Beranda</span></a>
    
        <li class="list-group">
            <a class="list-group-item" href="<?= base_url('unit/form_link_drive') ?>">
        ...
        <li class="list-group">
            <a class="list-group-item" href="<?= base_url('unit/datatindaklanjut') ?>">
